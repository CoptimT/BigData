 ...
 * Fail Over Client
 */
public class MyFailOverClient {
	
	public static void main(String[] args) {
		MyFailOverClientFacade client = new MyFailOverClientFacade();
		client.init();
		for (int i = 0; i < 10; i++) {
...
class MyFailOverClientFacade {
	...
	public void init() {
		...
		props.put("max-attempts", "2");//Must be >=0 (default: number of hosts specified)
