...
public class KafkaSpout implements IRichSpout {
	...
	private ConsumerConfig createConsumerConfig() {
      ...
      @Override
      public void close() {
           System.out.println(topic + " is going to be shutdown.");
      }
      ...
      public void deactivate() {
          System.out.println(topic + " has been deactivated!");
      }
 
      @Override
      public void nextTuple() {
    	  String value = "2015-7-6 2:49:40	0214CABFFE5B	860100010030100003	20040	283000	524000	000000000000";
    	  for(int i=0;i<100;i++){
    		  collector.emit(new Values(value), value);
    		  Utils.sleep(4*1000);
    	  }
      ...
      public void declareOutputFields(OutputFieldsDeclarer declarer) {
           declarer.declare(new Fields("KafkaSpoutFields"));
      }
